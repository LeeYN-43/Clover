...
from mmcv.runner import (HOOKS, DistSamplerSeedHook, OptimizerHook,
                         build_optimizer, get_dist_info)
from mmcv.runner.hooks import Fp16OptimizerHook
from mmcv.utils import build_from_cfg

from mmaction.core.runner import PrefetchEpochBasedRunner as EpochBasedRunner
from mmaction.core.hooks.prefetch_eval_hook import PrefetchEvalHook as EvalHook
from mmaction.core.hooks.prefetch_eval_hook import PrefetchDistEvalHook as DistEvalHook
from mmaction.core.hooks.prefetch_eval_hook import multi_gpu_test
...
def prefetch_train_model(model,
                         dataset,
                         cfg,
                         distributed=False,
                         validate=False,
    ...
    if 'base_lr' in cfg.optimizer:
        ...
        base_lr = cfg.optimizer.pop('base_lr')  # 如果设置了base_lr，就按照线性原则自动调整lr
        videos_per_gpu = cfg.data.get('videos_per_gpu', 1)
